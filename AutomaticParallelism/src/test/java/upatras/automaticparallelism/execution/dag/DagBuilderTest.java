...
public class DagBuilderTest {
	...
	/**
	 * Test of addTask method, of class DagBuilder.
	 */
	@Test
	public void largeScaleTest() {
		...
		assertEquals(dag.ordered.get(0).size(), 1);
		assertEquals(dag.ordered.get(1).size(), 33333);
		assertEquals(dag.ordered.get(2).size(), 333333);
		assertEquals(dag.ordered.get(3).size(), 1000000);
