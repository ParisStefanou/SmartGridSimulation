 ...
 * @author Paris
 */
public class SimpleRampGenerator extends SimpleRampDevice {

	public SimpleRampGenerator(Boolean on, ComplexPower max_power, ComplexPower ramp_rate_ms, PowerEnviroment enviroment) {
	...
	public void simulate(TimeStep simulation_step) {
		...
		producePower(new ComplexPower(average_active_power, average_reactive_power));
