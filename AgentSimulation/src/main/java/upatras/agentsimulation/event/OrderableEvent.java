 ...
 * @author Paris
 */
public abstract class OrderableEvent<O extends AbstractAgent, T extends AbstractAgent> extends Event<O, T> implements Comparable<OrderableEvent> {
    ...
    public OrderableEvent(O origin, Population<T> targets, DateTime event_time) {
     ...
     * @param event_time Timestamp of the event's occurance
     */
    public OrderableEvent(String name, O origin, Population<T> targets, DateTime event_time) {
